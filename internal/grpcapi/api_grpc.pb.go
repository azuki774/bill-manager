...
type ElectConsumeServiceClient interface {
	ElectConsumePost(ctx context.Context, in *OnedayElectConsume, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *electConsumeServiceClient) ElectConsumePost(ctx context.Context, in *OnedayElectConsume, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type ElectConsumeServiceServer interface {
	ElectConsumePost(context.Context, *OnedayElectConsume) (*empty.Empty, error)
...
func (UnimplementedElectConsumeServiceServer) ElectConsumePost(context.Context, *OnedayElectConsume) (*empty.Empty, error) {
